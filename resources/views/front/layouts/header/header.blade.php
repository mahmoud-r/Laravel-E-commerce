                                ...
                                <div class="d-lg-flex menu_banners row g-3 px-3">
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{asset('front_assets/images/menu_banner1.jpg')}}" alt="menu_banner1">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{asset('front_assets/images/menu_banner2.jpg')}}" alt="menu_banner2">
                                            <div class="banne_info">
                                                <h6>15% Off</h6>
                                                <h4>Men's Fashion</h4>
                                                <a href="#">Shop now</a>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="header-banner">
                                            <img src="{{asset('front_assets/images/menu_banner3.jpg')}}" alt="menu_banner3">
                                            <div class="banne_info">
                                                <h6>23% Off</h6>
                                                <h4>Kids Fashion</h4>
                                                <a href="#">Shop now</a>
                                        ...
                                        <ul class="d-lg-flex">
                                            <li class="mega-menu-col col-lg-4">
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item nav-link nav_item active" href="shop-left-sidebar.html">Left Sidebar</a></li>
                                            ...
                                            <div class="header_banner_content">
                                                <div class="shop_banner">
                                                    <div class="banner_img overlay_bg_40">
                                                        <img src="{{asset('front_assets/images/shop_banner.jpg')}}" alt="shop_banner"/>
                                                    </div>
