                ...
                <div class="banner_section shop_el_slider">
                    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active background_bg" data-img-src="{{asset('front_assets/images/banner13.jpg')}}">
                                <div class="banner_slide_content banner_content_inner">
                                    <div class="col-lg-7 col-10">
                                        <div class="banner_content3 overflow-hidden">
                                            <h5 class="mb-3 staggered-animation font-weight-light"
                                                data-animation="slideInRight" data-animation-delay="0.5s">Get up to 50%
                                                off Today Only!</h5>
                                            ...
                                            <h4 class="staggered-animation mb-4 product-price"
                                                data-animation="slideInRight" data-animation-delay="1.2s"><span
                            ...
                            <div class="carousel-item background_bg" data-img-src="{{asset('front_assets/images/banner14.jpg')}}">
                                <div class="banner_slide_content banner_content_inner">
                                    <div class="col-lg-8 col-10">
                                        <div class="banner_content3 overflow-hidden">
                                            <h5 class="mb-3 staggered-animation font-weight-light"
                                                data-animation="slideInRight" data-animation-delay="0.5s">50% off in all
                                                products</h5>
                                            <h2 class="staggered-animation" data-animation="slideInRight"
                            ...
                            <div class="carousel-item background_bg" data-img-src="{{asset('front_assets/images/banner15.jpg')}}">
                                <div class="banner_slide_content banner_content_inner">
                                    <div class="col-lg-8 col-10">
                                        <div class="banner_content3 overflow-hidden">
                                            <h5 class="mb-3 staggered-animation font-weight-light"
                                                data-animation="slideInRight" data-animation-delay="0.5s">Taking your
            ...
            <div class="col-lg-2 d-none d-lg-block">
                <div class="shop_banner2 el_banner1">
                    <a href="#" class="hover_effect1">
                        ...
                        <div class="el_img">
                            <img src="{{asset('front_assets/images/shop_banner_img6.png')}}" alt="shop_banner_img6">
                        </div>
                    </a>
                </div>
                <div class="shop_banner2 el_banner2">
                    <a href="#" class="hover_effect1">
                        ...
                        <div class="el_img">
                            <img src="{{asset('front_assets/images/shop_banner_img7.png')}}" alt="shop_banner_img7">
                        </div>
                    </a>
                </div>
            </div>
