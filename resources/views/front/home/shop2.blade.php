                                ...
                                <div class="deal_progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="46"
                                             aria-valuemin="0" aria-valuemax="100" style="width:46%"> 46%
                                        </div>
                                    </div>
                                </div>
                                <div class="countdown_time countdown_style4 mb-4"
                                     data-time="2024/5/14 12:30:15"></div>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                                ...
                                <div class="deal_progress">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="26"
                                             aria-valuemin="0" aria-valuemax="100" style="width:26%"> 26%
                                        </div>
                                    </div>
                                </div>
                                <div class="countdown_time countdown_style4 mb-4"
                                     data-time="2023/12/02 12:30:15"></div>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="deal_wrap">
                            ...
                            <div class="deal_content">
                                <div class="product_info">
                                    <h5 class="product_title"><a href="shop-product-detail.html">Nikon HD camera</a>
                                    </h5>
                                    <div class="product_price">
                                ...
                                <div class="countdown_time countdown_style4 mb-4"
                                     data-time="2023/11/02 12:30:15"></div>
                            </div>
                        </div>
                    </div>
                </div>
