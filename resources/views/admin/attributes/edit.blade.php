...
@endsection
@section('title')Attributes - {{$category->name}} @endsection
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name"  value="{{$attribute->name}}" id="name" class="form-control " placeholder="Name">
                                <p class="error"></p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex justify-content-end align-items-center">
                                    ...
                                    <div class="card-actions">
                                        <button  class=" btn  btn-danger ml-2"  onclick="AttributeDelete({{$attribute->id}},'{{$attribute->name}}')" type="button">
                                            Delete
                                        </button>
                                    </div>
                                    @endcan
                            ...
                            @forelse($attribute->values as $value)
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" required name="values[{{ $value->id }}][value]" class="form-control" value="{{$value->value}}">
                                    </td>
                                    <td>
...
@section('script')
    <script>
        ...
        function addValue() {
            ...
            var input = `<tr>
                    <td>
                        <input type="hidden" name="values[new][id]" value="">
                        <input type="text" required name="values[new][value]" class="form-control" value="">
                    </td>
                    <td>
        ...
        function AttributeDelete(id,name) {
            Swal.fire({
