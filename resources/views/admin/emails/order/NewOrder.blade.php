...
<div class="content">
    ...
    <p>Hello {{$admin}},</p>
    <p>A new order has been placed on {{ config('app.name') }}. Here are the details of the order:  <strong>{{$order->order_number}}</strong></p>
    ...
    <a href="{{ url('orders.view' . $order->id) }}" class="button">View Order</a>
