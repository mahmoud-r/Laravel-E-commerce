                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        @forelse($brands as $i=> $brand)
                            ...
                            <tr id="category_{{ $brand->id }}">
                                <td>{{ $brands->firstItem() + $i }}</td>
                                <td>
                                    <a href="{{route('brands.edit',$brand->id)}}" class="d-flex gap-2 align-items-center">

                                        @if(!empty($brand->image))
                                            <img src="{{asset('uploads/brands/images/thumb/'.$brand->image)}}" class="rounded" width="38" loading="lazy">
                                        @else
                                ...
                                <td>
                                    ...
                                    <a href="#" onclick="CategoryDelete({{$brand->id}},'{{$brand->name}}')" class="text-danger w-4 h-4 mr-1">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center"> Currently, there are no categories. <a href="{{ route('brands.create') }}">Add one?</a> </td>
                        </tr>
                        @endforelse
