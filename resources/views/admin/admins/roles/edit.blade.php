                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$role->name}}" name="name" id="name" class="form-control name" placeholder="Name">
                                <p class="error"></p>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($groupedPermissions as $group => $permissions)
                                    <div class="mb-3 col-md-4">
                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="ml-3">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input permission-checkbox" {{in_array($permission->id, $rolePermissions) ? 'checked':'' }} type="checkbox" name="permission[]" id="{{ $permission->name }}" value="{{ $permission->name}}">
